#!/usr/bin/env python3
"""
Spotify NP Script (Local Edition) v1.7#!/usr/bin/env python3
"""
Spotify NP Script (Local Edition) v1.7
Maker: blind_peer

- Prompts for Spotify Client ID, defaults to edd9f875459749aebb6b75f88f47c662 if empty.
- Generates all required files and sets up the local environment.
"""
...
DEFAULT_CID = "edd9f875459749aebb6b75f88f47c662"

# One-line bookmarklet with a literal {cid} placeholder
...
def write_file(path, content):
    """Write dedented content to file."""
    with open(path, 'w', encoding='utf-8') as f:
        f.write(dedent(content).lstrip())

def main():
    print("=============================================")
    print(" Spotify NP Script (Local Edition) v1.7")
    print(" Maker: blind_peer")
    print("=============================================\n")
    print("If you don't have your own Spotify Client ID, just press Enter to use the default public client.")
    cid = input(f"Enter your Spotify Client ID (or leave blank for default): ").strip()
    if not cid:
        cid = DEFAULT_CID
        print(f"\n[!] Using default client ID: {cid}\n(This is public, but safe for personal use.)\n")

    print("[✔] Generating files in:", os.getcwd(), "\n")
